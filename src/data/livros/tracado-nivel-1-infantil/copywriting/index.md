...
hero-section:
  ...
  title: Traçado - Nível 1
identity-colors:
  primary-background-color: '#F9F6F0'
  primary-emphasis-color: '#8B4513'
...
sample-section:
  list-sample:
  - description: Desenvolvimento da precisão dos pequenos músculos das mãos para o
      controle total da escrita.
    image: sample/sample_005.png
    subtitle: Controle Muscular
    title: Motricidade Fina
  - description: Integração entre o estímulo visual da página e a resposta motora
      precisa do punho e dedos.
    image: sample/sample_015.png
    subtitle: Visão e Gesto
    title: Coordenação Visuomotora
  - description: Regulação da força aplicada sobre o papel para garantir traços nítidos
      e fluidez no gesto.
    image: sample/sample_025.png
    subtitle: Tônus Muscular
    title: Controle de Pressão
  - description: Compreensão e respeito às margens, linhas e proporções adequadas
      para cada caráter.
    image: sample/sample_035.png
    subtitle: Limite da Página
    title: Organização Espacial
  - description: Desenvolvimento de um movimento contínuo que prepara para a agilidade
      da escrita cursiva.
    image: sample/sample_045.png
    subtitle: Ritmo da Escrita
    title: Fluidez do Traço
  - description: Atenção técnica aos detalhes de curvas e retas na formação correta
      de cada letra e número.
    image: sample/sample_055.png
    subtitle: Desenho de Caracteres
    title: Precisão do Gesto
  - description: Exercícios preparatórios que conectam traços individuais em movimentos
      fluídos e contínuos.
    image: sample/sample_065.png
    subtitle: Transição de Estilo
    title: Prontidão para Cursiva
  subtitle: Um sumário visual da nossa excelência em Traçado
...
schema-org:
  ...
  inLanguage: pt-BR
  isbn: '9786585080002'
  name: Apostila de Traçado - Nível 1
  numberOfPages: 118
seller-urls:
  amazon-book: ''
  umlivro-book: ''
