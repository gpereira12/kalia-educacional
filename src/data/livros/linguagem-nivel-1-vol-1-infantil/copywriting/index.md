...
hero-section:
  image-main: mockup_3d.png
  subtitle: Apostila de Alfabetização - Nível 1 | As Vogais
  title: Linguagem - Nível 1 | Vol. 1
identity-colors:
  primary-background-color: '#F9F6F0'
  primary-emphasis-color: '#1B365D'
...
sample-section:
  list-sample:
  - description: Desenvolvimento da percepção rítmica e sonora fundamental para a
      decodificação da alfabetização.
    image: sample/sample_005.png
    subtitle: Processamento Sonoro
    title: Consciência Fonológica
  - description: Ampliação da base de termos e conceitos através de exposição a contextos
      semânticos variados.
    image: sample/sample_015.png
    subtitle: Expansão de Vocabulário
    title: Repertório Lexical
  - description: Exercícios direcionados à formação de símbolos linguísticos e reconhecimento
      de padrões de caracteres.
    image: sample/sample_025.png
    subtitle: Habilidades Pré-Gráficas
    title: Prontidão para Escrita
  - description: Domínio das estruturas gramaticais para a correta articulação e organização
      do pensamento.
    image: sample/sample_035.png
    subtitle: Organização Lógica
    title: Estruturação Sintática
  - description: Treino prático de decodificação fonética integrada à compreensão
      imediata de textos curtos.
    image: sample/sample_045.png
    subtitle: Decodificação e Sentido
    title: Fluidez de Leitura
  - description: Exercícios voltados para a distinção de fonemas e retenção de informações
      ouvidas em sala.
    image: sample/sample_055.png
    subtitle: Foco Atencional
    title: Processamento Auditivo
  - description: Aplicação sistemática de sons e grafemas para uma alfabetização acelerada
...
schema-org:
  ...
  inLanguage: pt-BR
  isbn: '9786585080019'
  name: Apostila de Linguagem - Nível 1
  numberOfPages: 148
seller-urls:
  amazon-book: ''
  umlivro-book: ''
