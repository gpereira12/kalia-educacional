...
presentation-section:
  description: Desenvolvida por especialistas, esta apostila de Habilidades Cognitivas
    ...
    sólido e duradouro para o Alfabetização - Nível 1.
  image-main: capa_plana.png
  title: 'Uma Formação que Eleva a Alma: Habilidades Cognitivas'
sample-section:
  list-sample:
  - description: Cultivo da capacidade de manter a concentração em tarefas específicas
      por períodos controlados.
    image: sample/sample_005.png
    subtitle: Foco Prolongado
    title: Atenção Sustentada
  - description: Identificação rápida de detalhes, diferenças e semelhanças em estímulos
      visuais complexos.
    image: sample/sample_015.png
    subtitle: Discriminação de Imagem
    title: Processamento Visual
  - description: Exercícios para fortalecer a capacidade de reter e manipular informações
      em curto prazo.
    image: sample/sample_025.png
    subtitle: Retenção Temporária
    title: Memória de Trabalho
  - description: Treino da capacidade de frear impulsos e seguir instruções sequenciais
      com precisão.
    image: sample/sample_035.png
    subtitle: Autorregulação
    title: Controle Inibitório
  - description: Estímulo à mudança de estratégia mental diante de novos desafios
      lógicos e situacionais.
    image: sample/sample_045.png
    subtitle: Diferentes Perspectivas
    title: Flexibilidade Cognitiva
  - description: Capacidade de extrair leis gerais a partir de exemplos particulares,
      base da inteligência teórica.
    image: sample/sample_055.png
    subtitle: Extração de Lógica
    title: Raciocínio Abstrato
  - description: Desenvolvimento do método de organizar etapas para atingir um objetivo
      prático com eficiência.
...
schema-org:
  ...
  inLanguage: pt-BR
  isbn: '9786599843853'
  name: Apostila de Habilidades Cognitivas - Nível 1
  numberOfPages: 202
seller-urls:
  amazon-book: ''
  umlivro-book: ''
