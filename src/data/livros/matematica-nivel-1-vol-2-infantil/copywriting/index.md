...
hero-section:
  image-main: mockup_3d.png
  subtitle: Apostila de Alfabetização - Nível 1 | Maestria dos Numeros
  title: Matemática - Nível 1 | Vol. 2
identity-colors:
  primary-background-color: '#F9F6F0'
  primary-emphasis-color: '#800020'
  primary-text-color: '#1A1A1A'
  secondary-background-color: '#E9D5A1'
  secondary-emphasis-color: '#D1A27A'
  secondary-text-color: '#4A4A4A'
interior-section:
  list-interior:
  - image: miolo/miolo_008.png
  - image: miolo/miolo_012.png
  - image: miolo/miolo_020.png
  - image: miolo/miolo_028.png
  - image: miolo/miolo_032.png
  - image: miolo/miolo_040.png
  - image: miolo/miolo_048.png
  - image: miolo/miolo_052.png
  - image: miolo/miolo_060.png
  - image: miolo/miolo_070.png
  subtitle: Navegue pelas páginas deste tesouro
  title: A Beleza Revelada
isbn: '9786585080026'
nivel: Alfabetização - Nível 1
presentation-section:
  description: Desenvolvida por especialistas, esta apostila de Matemática combina
    o rigor acadêmico com a beleza da tradição, proporcionando um aprendizado sólido
    e duradouro para o Alfabetização - Nível 1.
  image-main: capa_plana.png
  title: 'Uma Formação que Eleva a Alma: Matemática'
sample-section:
  list-sample:
  - description: Identificação da relação biunívoca entre o símbolo numérico e o valor
      concreto correspondente.
    image: sample/sample_005.png
    subtitle: Correspondência Numérica
    title: Noção de Quantidade
  - description: Introdução às operações de adição e subtração via manipulação de
      elementos reais e simbólicos.
    image: sample/sample_015.png
    subtitle: Cálculo Fundamental
    title: Operações Aritméticas
  - description: Desenvolvimento da percepção tridimensional, reconhecimento de formas
      e organização espacial.
    image: sample/sample_025.png
    subtitle: Geometria e Volume
    title: Pensamento Espacial
  - description: Exercícios de seriação, classificação e identificação de padrões
      lógicos recorrentes.
    image: sample/sample_035.png
    subtitle: Sequenciamento e Ordem
    title: Raciocínio Lógico
  - description: Aplicação de conceitos matemáticos para resolver situações-problema
      de forma autônoma.
    image: sample/sample_045.png
    subtitle: Algoritmos Mentais
    title: Resolução de Problemas
  - description: Transição segura da contagem concreta para a manipulação mental de
      números e valores abstratos.
    image: sample/sample_055.png
    subtitle: Pensamento Matemático
    title: Abstração Numérica
  - description: Compreensão prática das unidades de medida de tempo, peso e volume
...
schema-org:
  ...
  inLanguage: pt-BR
  isbn: '9786585080026'
  name: Apostila de Matemática - Nível 1
  numberOfPages: 191
seller-urls:
  amazon-book: ''
  umlivro-book: ''
selo-editorial: Kalia Educacional
technical-section:
  technical:
  - description: 21cm x 29,7cm (A4)
    title: Tamanho
  - description: '191'
    title: Páginas
  ...
  - description: Português
    title: Idioma
  - description: Kalia Educacional
    title: Editora
  - description: '9786585080026'
    title: ISBN
  title: Ficha Técnica
tipo: apostila
---