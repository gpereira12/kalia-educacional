...
const differentiators = [
  {
    ...
    description: "Cada detalhe visual é uma celebração da beleza que transcende o tempo."
  },
  {
    icon: Lightbulb,
    title: "Sabedoria Perene",
    description: "Conhecimento destilado com clareza e profundidade acadêmica."
  },
  {
    icon: BookOpen,
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
          {differentiators.map((item, index) => (
            <motion.div
              ...
              className={`group p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] bg-white/40 backdrop-blur-xl border border-black/5 hover:border-primary/30 hover:bg-white/80 transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-primary/5 ${
                index === 0 ? "md:col-span-12 lg:col-span-7" : 
